...
public class OrdenController {
    ...
    public ResponseEntity<OrdenResponseDTO> crearProducto(@RequestBody OrdenRequestDTO ordenRequestDTO) {
        log.info("📌 Iniciando petición para crear Producto: {}", ordenRequestDTO.getNombre());

        OrdenResponseDTO crearProductoResponse = ordenService.crearProducto(ordenRequestDTO);

        log.info("📌 Finaliza petición para crear Producto: {}", ordenRequestDTO.getNombre());
